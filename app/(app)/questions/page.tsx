...
import { Search, Plus, Download, Upload, BookOpen, Loader2, Trash2 } from 'lucide-react'
import { apiRequest } from '@/lib/api/client'
import type { Question, Difficulty, QuestionFilters } from '@/types'
...
export default function QuestionsPage() {
  ...
  const [filters, setFilters] = useState<QuestionFilters>({ page: 1, per_page: 20 })
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-4 space-y-3">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          {filters.difficulty && (
            <button
              onClick={() => setFilters(f => ({ ...f, difficulty: undefined, page: 1 }))}
